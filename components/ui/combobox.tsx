...
function ComboboxContent({
  ...
  >) {
  // When rendered inside a Dialog, portal the popup *into* the dialog content
  // so it stays within the dialog's focus trap / scroll lock / pointer-events
  // region (otherwise items are unclickable and scrolling is blocked).
